(function () {
    ...
    DiGraph.prototype.topsort = function () {
        if (!this._directed)return new Error("Not a Directed Acyclic Graph");
        var topSortOrder = [];
    ...
    DiGraph.prototype.traverseDFS = function (vertexVisitCallback,thisArg, backEdgeCallback) {
                ...
                (function visitChild(v) {
                    ...
                    edges.every(function (child) {
                        if (!(child in child2ParentMap)) {
                            ...
                            visitChild(child);
                            return vertexVisitCallback.call(thisArg || graph, child, v);
                        }
                        return true;
                    });
                })(vertex);
                return vertexVisitCallback.call(thisArg || graph, vertex, null);
            }
            return true;
